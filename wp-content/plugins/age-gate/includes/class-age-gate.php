...
class Age_Gate
{
    ...
    private function load_dependencies()
    {
        ...
        require_once AGE_GATE_PATH . 'admin/class-age-gate-v3.php';
        ...
        require_once AGE_GATE_PATH . 'includes/class-age-gate-cron.php';
    ...
    private function define_admin_hooks()
    {
         ...
         * V3 info
         */
        $this->loader->add_action('admin_menu', $plugin_v3, 'add_settings_page', 100);
        ...
        $this->loader->add_action('wp_ajax_set_ag3_hidden', $plugin_ajax, 'set_ag3_hidden');
    ...
    private function define_public_hooks()
    {
        ...
        $this->loader->add_action('wp_head', $plugin_presentation, 'preload', 4);
