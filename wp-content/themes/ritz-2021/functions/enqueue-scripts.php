...
function site_scripts() {
  global $wp_styles; // Call global $wp_styles variable to add conditional wrapper around ie stylesheet the WordPress way
    ...
    wp_enqueue_script( 'ritz-js', get_template_directory_uri() . '/assets/scripts/ritz.js', array( 'slick-js' ), filemtime(get_template_directory() . '/assets/scripts/ritz.js'), true );
