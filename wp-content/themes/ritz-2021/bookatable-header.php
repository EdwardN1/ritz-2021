                                ...
                                <div class="cell shrink dining">
                                    ...
                                    <div class="dropdown-pane" id="bookings-panel" data-dropdown data-close-on-click="true"
                                        ...
                                        <?php if ( have_rows( 'the_ritz_restaurant' ) ) : ?>
                                            ...
                                            <?php endwhile; ?>
                                            <div class="booking-line">
                                                <!--<a <?php /*echo $book_data; */?>>The Ritz Restaurant</a>-->
                                                <!--<a data-toggle="off-canvas-restaurant">The Ritz Restaurant</a>-->
                                        ...
                                        <?php if ( have_rows( 'afternoon_tea' ) ) : ?>
                                            ...
                                            <?php endwhile; ?>
                                            <div class="booking-line">
                                                <!--<a <?php /*echo $book_tea_data; */?>>Afternoon Tea</a>-->
                                                <!--<a data-toggle="off-canvas-afternoon-tea" >Afternoon Tea</a>-->
